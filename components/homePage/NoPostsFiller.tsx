        ...
        <div className="swiper people__slide">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="people__card">
                <div className="people__image">
                  <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEilxyO1qVTv5gmAWkpwuQZBBAMYk6xjqCXZ93jKlK1N9e3i2b57tMDWS3OQVA8ViAxQtgwsO1F1AqeX9MWo0owTh7jUpGjHyiCkLsdB3jvLtAYJkAHm72D3AQb19YYA2vXqDR6l0EI8dpHWCcCmFtL8fNsokWePH-S6LyHMn3ruRKUA17TaDN3lcphv4vw/s320/narsi.jpg" alt="Narsi Jangid" />
                </div>
            ...
            <div className="swiper-slide">
              <div className="people__card">
                <div className="people__image">
                  <img src="https://blogger.googleusercontent.com/img/a/AVvXsEizRzmsA6-km8m8PvXZo5iKjG7OLdg-5UlA9hnI4-dwb7f6vnn08Uya9NdYmDSQA89ADx7cSNUHF0PrS5utIA69O2jM1AjzIcBMEJTV5JtCzD4TbZKa0fOWemAKq0A8RrMfsOtSguXhuV0SoYbyFpKqi9plizkhDPR0EOstV_CZnKaAijaPge7musXE2oY" alt="Dazzlone" />
                </div>
                <div className="people__info">
                  <ul className="people__social">
                    <li><a href="#" aria-label="Facebook"><i className="fa-brands fa-facebook-f" /></a></li>
            ...
            <div className="swiper-slide">
              <div className="people__card">
                <div className="people__image">
                  <img src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Free4Talk" />
                </div>
                <div className="people__info">
                  <ul className="people__social">
                    <li><a href="#" aria-label="Facebook"><i className="fa-brands fa-facebook-f" /></a></li>
