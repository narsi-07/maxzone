...
function UserPost({
 ...
 {postInformation?.mediaURL && 
      <video className="h-[175px] w-[300px] select-none bg-[#ebebeb] object-cover dark:bg-[#313131] sm:h-[300px]"
