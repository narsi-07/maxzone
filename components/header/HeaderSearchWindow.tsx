...
function HeaderSearchWindow({
  ...
  return (
    <div
      ...
      className="absolute left-[0px] top-[49px] h-[389px] w-[300px] overflow-hidden rounded-md bg-white shadow-[-2px_-2px_10px_2px_rgba(0,0,0,0.1)] dark:bg-[#1c1c1c] dark:shadow-[-2px_-2px_5px_0px_rgba(0,0,0,0.7)]"
    >
